...
Bereits im [[./Clean Code Developer/Grade/Gelber Grad|gelben Grad]] hat der [[./Clean Code Developer/index|CCD]] das [[./Dependency Inversion Principle|Dependency Inversion Principle]] kennengelernt. Dabei wurden die Abhängigkeiten noch „von Hand“ aufgelöst. Der nächste logische Schritt besteht nun darin, das Auflösen der Abhängigkeiten zu automatisieren. Dazu stehen zwei Verfahren zur Verfügung:
