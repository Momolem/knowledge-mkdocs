...
Reviews ergänzen dynamische Tests, wie z.B. den automatischen [[./Unit Test|Unit Test]] oder den automatischen Integrationstest aus dem [[./Clean Code Developer/Grade/Gelber Grad|Gelben Grad]] bzw. [[./Clean Code Developer/Grade/Orangener Grad|Orangenen Grad]] Im Gegensatz zu diesen Tests, sind Reviews auch sehr gut geeignet, Fehler in den Anforderungen zu finden. Auch können sie bereits sehr früh im Entwicklungsprozess eingesetzt und Fehler dadurch auch sehr früh gefunden werden. Und um so früher Fehler gefunden werden, um so günstiger ist auch deren Beseitigung.

An den orangen Grad schließt sich der [[./Clean Code Developer/Grade/Gelber Grad|Gelbe Grad]] an.