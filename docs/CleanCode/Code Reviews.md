...
Reviews ergänzen dynamische Tests, wie z.B. den automatischen [Unit Test](CleanCode/Unit%20Test.md) oder den automatischen Integrationstest aus dem [Gelben Grad](CleanCode/Gelber%20Grad.md) bzw. [Orangenen Grad](CleanCode/Orangener%20Grad.md) Im Gegensatz zu diesen Tests, sind Reviews auch sehr gut geeignet, Fehler in den Anforderungen zu finden. Auch können sie bereits sehr früh im Entwicklungsprozess eingesetzt und Fehler dadurch auch sehr früh gefunden werden. Und um so früher Fehler gefunden werden, um so günstiger ist auch deren Beseitigung.

An den orangen Grad schließt sich der [Gelbe Grad](CleanCode/Gelber%20Grad.md) an.