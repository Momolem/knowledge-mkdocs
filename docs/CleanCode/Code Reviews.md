...
Reviews ergänzen dynamische Tests, wie z.B. den automatischen [Unit Test](./Unit%20Test.md) oder den automatischen Integrationstest aus dem [Gelben Grad](./Clean%20Code%20Developer/Grade/Gelber%20Grad.md) bzw. [Orangenen Grad](./Clean%20Code%20Developer/Grade/Orangener%20Grad.md) Im Gegensatz zu diesen Tests, sind Reviews auch sehr gut geeignet, Fehler in den Anforderungen zu finden. Auch können sie bereits sehr früh im Entwicklungsprozess eingesetzt und Fehler dadurch auch sehr früh gefunden werden. Und um so früher Fehler gefunden werden, um so günstiger ist auch deren Beseitigung.

An den orangen Grad schließt sich der [Gelbe Grad](./Clean%20Code%20Developer/Grade/Gelber%20Grad.md) an.