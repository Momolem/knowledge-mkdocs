...
**Strategy** is a [behavioral design pattern](CleanCode/Design%20Patterns.md#behavioral) that lets you define a family of algorithms, put each of them into a separate class, and make their objects interchangeable.
...
| [Open Closed Principle](CleanCode/Open%20Closed%20Principle.md). You can introduce new strategies without having to change the context. | |
...
- [Decorator](CleanCode/Decorator.md) lets you change the skin of an object, while [Strategy](CleanCode/Strategy.md) lets you change the guts.
- [Template Method](CleanCode/Template%20Method.md) is based on inheritance: it lets you alter parts of an algorithm by extending those parts in subclasses. [Strategy](CleanCode/Strategy.md) is based on composition: you can alter parts of the object’s behavior by supplying it with different strategies that correspond to that behavior. Template Method works at the class level, so it’s static. Strategy works on the object level, letting you switch behaviors at runtime.
- [State](CleanCode/State.md) can be considered as an extension of Strategy. Both patterns are based on [composition](composition.md): they change the behavior of the context by delegating some work to helper objects. [Strategy](CleanCode/Strategy.md) makes these objects completely independent and unaware of each other. However, [State](CleanCode/State.md) doesn’t restrict dependencies between concrete states, letting them alter the state of the context at will.