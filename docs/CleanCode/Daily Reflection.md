...
Im Zentrum von [CCD](CleanCode/Clean%20Code%20Developer.md) steht die persönliche Entwicklung. Es geht also um Veränderung: Mit jedem Tag soll sich das [CCD-Wertesysten](CleanCode/Clean%20Code%20Developer.md#wertesystem) ein klein wenig mehr im Projektalltag des [Clean Code](CleanCode/Clean%20Code.md) Developers manifestieren. Das ist die Pfadfinderregel des [Clean Code Developer](CleanCode/Clean%20Code%20Developer.md)s auf sich selbst angewandt.
