...
Das IOSP lässt sich „aus dem Stand“ von jedem Entwickler guten Willens anwenden. Seine Einhaltung ist durch jedermann leicht zu überprüfen. Integrationen und Operationen unterscheiden sich in der Form deutlich. Weitere Details, insbesondere zur Abgrenzung zum [Dependency Inversion Principle](CleanCode/Dependency%20Inversion%20Principle.md), [findest du bspw. hier](https://ccd-akademie.de/dip-oder-iosp/).