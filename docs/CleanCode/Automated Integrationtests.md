...
Die fundamentale Voraussetzung für jegliche Änderungen am Code haben wir bereits im [Roten Grad](./Clean%20Code%20Developer/Grade/Roter%20Grad.md) durch den Einsatz eines Versionskontrollsystems gelegt. Wir können ohne Sorge Änderungen am Code vornehmen, ganze Dateien und Verzeichnisse löschen, durch das Versionskontrollsystem ist alles wieder abrufbar.
