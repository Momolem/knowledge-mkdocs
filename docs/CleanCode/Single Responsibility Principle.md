...
Das Single Responsibility Principle ([SRP](http://web.archive.org/web/20160716150726/http://objectmentor.com/resources/articles/srp.pdf)) ist eines der [SOLID](CleanCode/SOLID.md) Prinzipien. Es lautet: Eine Klasse sollte nur **eine** Verantwortlichkeit haben.
