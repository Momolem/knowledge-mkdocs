...
Architektur und Implementation sollen nicht überlappen, damit sie das [DRY](./DRY.md)-Prinzip nicht verletzten. So werden Inkonsistenzen vermieden, die dadurch entstehen können, dass auf der einen Seite etwas geändert wird, ohne diese Änderung auf der anderen Seite nachzuführen.
