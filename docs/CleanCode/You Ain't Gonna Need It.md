...
Das YAGNI-Prinzip (_You Ain´t Gonna Need It_) ist eines der einfachsten in der Softwareentwicklung – und doch wohl das nach dem [[./Clean Code Developer/Prinzipien/DRY|DRY]]-Prinzip am häufigsten verletzte Prinzip. Deshalb steht YAGNI nicht nur am Anfang des [[./Clean Code Developer/Grade/Roter Grad|roten Grades]], sondern auch hier gegen Ende des Weges durch das [[./Clean Code Developer/index#Wertesystem|Wertesystem]].
...
[[./Clean Code Developer/index|CCD]] als professionelle Entwickler kommunizieren diese Vorgehensweise unmissverständlich dem Kunden gegenüber. Dadurch werden sie:
...
YAGNI ist deshalb nicht nur ein Prinzip, das jeder Entwickler befolgen soll, sondern auch ein Prinzip für Projekte und Teams, also auf Organisationsebene. YAGNI ist immer in Anschlag zu bringen, genauso wie [[./Clean Code Developer/Prinzipien/DRY|DRY]]. Wenn im Zweifel, dann verschiebe die Entscheidung falls möglich. Ansonsten entscheide dich gegen den Aufwand. Das entspannt und entschlackt und führt schneller zum Erfolg.