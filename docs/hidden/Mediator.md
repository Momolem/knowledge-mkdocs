...
![[undefineddocs/assets/img/37d7a04dad81c2552f0470aacc722961_MD5.png|37d7a04dad81c2552f0470aacc722961_MD5.png]]
...
![[undefineddocs/assets/img/a09540232a756f6c331a3aab5ac27a97_MD5.png|a09540232a756f6c331a3aab5ac27a97_MD5.png]]
...
![[undefineddocs/assets/img/d4770ce0f346443374185fbc490fc7f3_MD5.png|d4770ce0f346443374185fbc490fc7f3_MD5.png]]
...
![[undefineddocs/assets/img/e4731751970db6c14ff3d4430b6a48c7_MD5.png|e4731751970db6c14ff3d4430b6a48c7_MD5.png]]
...
![[undefineddocs/assets/img/984ffe30e8979eeb77dc09ce78003a63_MD5.png|984ffe30e8979eeb77dc09ce78003a63_MD5.png]]
...
![[undefineddocs/assets/img/6796e049e0bc38f591cafcb015221fdb_MD5.png|6796e049e0bc38f591cafcb015221fdb_MD5.png]]
...
4.  You can go even further and make the mediator responsible for the creation and destruction of component objects. After this, the mediator may resemble a [[undefineddocs/hidden/Factory|Factory]] or a [[undefineddocs/hidden/Facade|Facade]].
...
| Pros | Cons |
| --- | --- |
| [[undefineddocs/hidden/Single Responsibility Principle|Single Responsibility Principle]]. You can extract the communications between various components into a single place, making it easier to comprehend and maintain. |  Over time a mediator can evolve into a [[God Object|God Object]].
| [[undefineddocs/hidden/Open Closed Principle|Open Closed Principle]]. You can introduce new mediators without having to change the actual components. ||
| You can reduce coupling between various components of a program.||
| You can reuse individual components more easily.||

## Relations with Other Patterns
- [[undefineddocs/hidden/Chain of Responsibility|Chain of Responsibility]], [[undefineddocs/hidden/Command|Command]], Mediator and [[undefineddocs/hidden/Observer|Observer]] address various ways of connecting senders and receivers of requests:
	...
	- [[undefineddocs/hidden/Command|Command]] establishes unidirectional connections between senders and receivers.
...
- [[undefineddocs/hidden/Facade|Facade]] and Mediator have similar jobs: they try to organize collaboration between lots of tightly coupled classes.
	- [[undefineddocs/hidden/Facade|Facade]] defines a simplified interface to a subsystem of objects, but it doesn’t introduce any new functionality. The subsystem itself is unaware of the [[undefineddocs/hidden/Facade|Facade]]. Objects within the subsystem can communicate directly.
	- Mediator centralizes communication between components of the system. The components only know about the mediator object and don’t communicate directly.
- The difference between Mediator and [[undefineddocs/hidden/Observer|Observer]] is often elusive. In most cases, you can implement either of these patterns; but sometimes you can apply both simultaneously. Let’s see how we can do that.
	
	The primary goal of Mediator is to eliminate mutual dependencies among a set of system components. Instead, these components become dependent on a single mediator object. The goal of [[undefineddocs/hidden/Observer|Observer]] is to establish dynamic one-way connections between objects, where some objects act as subordinates of others.

	There’s a popular implementation of the Mediator pattern that relies on [[undefineddocs/hidden/Observer|Observer]]. The mediator object plays the role of publisher, and the components act as subscribers which subscribe to and unsubscribe from the mediator’s events. When Mediator is implemented this way, it may look very similar to [[undefineddocs/hidden/Observer|Observer]].

	When you’re confused, remember that you can implement the Mediator pattern in other ways. For example, you can permanently link all the components to the same mediator object. This implementation won’t resemble [[undefineddocs/hidden/Observer|Observer]] but will still be an instance of the Mediator pattern.
