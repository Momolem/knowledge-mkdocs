...
**Strategy** is a [[undefineddocs/hidden/Design Patterns#Behavioral|behavioral design pattern]] that lets you define a family of algorithms, put each of them into a separate class, and make their objects interchangeable.
...
![[undefineddocs/assets/img/2ebaf6edc15a2db946e26eda44c402b6_MD5.png|2ebaf6edc15a2db946e26eda44c402b6_MD5.png]]
...
![[undefineddocs/assets/img/d825db2695100d0e2617b24ab5ce60e4_MD5.png|d825db2695100d0e2617b24ab5ce60e4_MD5.png]]
...
![[undefineddocs/assets/img/17451ba8526af91af1711f7f8e93f256_MD5.png|17451ba8526af91af1711f7f8e93f256_MD5.png]]
...
![[undefineddocs/assets/img/6b3c4757eca12a7a9492b316d0696630_MD5.png|6b3c4757eca12a7a9492b316d0696630_MD5.png]]
...
| [[undefineddocs/hidden/Open Closed Principle|Open Closed Principle]]. You can introduce new strategies without having to change the context. | |

## Relations with Other Patterns
- [[undefineddocs/hidden/Bridge|Bridge]], [[undefineddocs/hidden/State|State]], [[Strategy|Strategy]] (and to some degree [[undefineddocs/hidden/Adapter|Adapter]]) have very similar structures. Indeed, all of these patterns are based on [[composition|composition]], which is delegating work to other objects. However, they all solve different problems. A pattern isn’t just a recipe for structuring your code in a specific way. It can also communicate to other developers the problem the pattern solves.
- [[undefineddocs/hidden/Command|Command]] and [[Strategy|Strategy]] may look similar because you can use both to parameterize an object with some action. However, they have very different intents.
	- You can use [[undefineddocs/hidden/Command|Command]] to convert any operation into an object. The operation’s parameters become fields of that object. The conversion lets you defer execution of the operation, queue it, store the history of commands, send commands to remote services, etc.
...
- [[undefineddocs/hidden/Decorator|Decorator]] lets you change the skin of an object, while [[Strategy|Strategy]] lets you change the guts.
